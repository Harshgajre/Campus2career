            ...
            <div className="lg:col-span-7 flex flex-col justify-between h-full pr-0 lg:pr-4">
              <div>
                ...
                <div className="inline-block mb-4">
                  <span className="px-3.5 py-1.5 rounded-full text-xs font-bold bg-[#E6F9F0] text-[#00A865]">
                    For Students
                  </span>
                </div>
            ...
            <div className="lg:col-span-5">
              <div className="w-full rounded-2xl p-6 sm:p-8 border border-slate-200/80 bg-white shadow-xl text-slate-900">
                ...
                <div className="flex justify-center mb-4">
                  <div className="w-14 h-14 rounded-full bg-[#E6F9F0] flex items-center justify-center text-[#00B26E] shadow-inner">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 text-xs rounded-xl border border-slate-200 bg-slate-50/80 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#00B26E] transition-all"
                      required
                    />
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-10 py-2.5 text-xs rounded-xl border border-slate-200 bg-slate-50/80 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#00B26E] transition-all"
                      required
                    />
                    <button
                      type="button"
