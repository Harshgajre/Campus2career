...
import { Mail, Lock, Eye, EyeOff, GraduationCap, Sun, Moon, Sparkles } from 'lucide-react';
...
export const StudentLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await login(email || 'student@demo.com', password || 'password123');
    setLoading(false);
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 font-sans ${isDarkMode ? 'bg-[#060B18] text-white dark' : 'bg-[#F4F7FF] text-slate-900'}`}>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-slate-800 p-1 rounded-xl">
            <button
              ...
              className="px-3 py-1 rounded-lg bg-[#00B26E] text-white font-bold shadow-sm transition-all flex items-center gap-1"
            >
              🎓 Student
            </button>
            <button
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 sm:py-12 flex flex-col justify-center min-h-[calc(100vh-60px)]">
        ...
        {/* Main Card Container with Outer Border & Soft Shadow matching design */}
          ...
          <div className="flex flex-col items-center justify-center mb-8">
            <div className="flex items-center gap-2">
              <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight">
                ...
                <span className={isDarkMode ? 'text-emerald-400' : 'text-emerald-500'}>Career</span>
              </h1>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col justify-between h-full pr-0 lg:pr-4">
              <div>
                ...
                <div className="inline-block mb-4">
                  <span className={`px-3.5 py-1.5 rounded-full text-xs font-bold transition-all ${
                    isDarkMode
                      ? 'bg-[#004B2F] text-[#00E68A]'
                      : 'bg-[#E6F9F0] text-[#00A865]'
                  }`}>
                    For Students
                  </span>
                </div>
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight mb-3">
                  Big Dreams <br />
                  <span className="text-[#00B26E] dark:text-[#00C875]">Start Here</span>
                </h2>
                ...
                <p className={`text-sm sm:text-base leading-relaxed max-w-lg mb-6 ${
                  ...
                  Learn today, build your skills, and step into a brighter tomorrow.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg border border-slate-200/50 dark:border-slate-800/80 group">
                <img
                  src={isDarkMode ? studentHeroDark : studentHeroLight}
                  alt="Student Career Pathway Illustration"
            ...
            <div className="lg:col-span-5">
              <div className={`w-full rounded-2xl p-6 sm:p-8 border transition-all ${
                ...
                <div className="flex justify-center mb-4">
                  <div className="w-14 h-14 rounded-full bg-[#E6F9F0] dark:bg-[#062E1E] flex items-center justify-center text-[#00B26E] dark:text-[#00C875] shadow-inner">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-2.5 text-xs rounded-xl border transition-all focus:outline-none focus:ring-2 focus:ring-[#00B26E] ${
                          isDarkMode
                  ...
                  <div>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-10 py-2.5 text-xs rounded-xl border transition-all focus:outline-none focus:ring-2 focus:ring-[#00B26E] ${
                          isDarkMode
                            ? 'bg-[#060D1E] border-slate-800 text-white placeholder-slate-500'
                            : 'bg-slate-50/80 border-slate-200 text-slate-900 placeholder-slate-400'
                        }`}
                  ...
                  <div className="flex items-center justify-between text-xs pt-1">
                    <label className="flex items-center gap-2 cursor-pointer select-none">
                      <input
                        ...
                        className="w-3.5 h-3.5 rounded border-slate-300 text-[#00B26E] focus:ring-[#00B26E]"
                      />
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-3 px-4 rounded-xl bg-[#00B26E] hover:bg-[#009b5f] disabled:opacity-50 text-white font-bold text-xs transition-all shadow-md shadow-[#00B26E]/20 flex items-center justify-center gap-2 mt-2"
                  >
                    {loading ? (
                ...
                <div className="text-center mt-4 text-xs">
                  ...
                  <Link
                    to="/register/student"
                    className="font-bold text-[#00B26E] dark:text-[#00C875] hover:underline"
                  >
                    Register here
                  </Link>
                </div>
